...
def example_basic_usage():
    """Basic usage example with CANDY Flat."""
    print("=" * 60)
    print("Example 1: Basic Usage with CANDY Flat")
    print("=" * 60)
    ...
    print("Top-5 neighbors for first query:")
...
def example_faiss_hnsw():
    ...
    print("Found top-5 neighbors using ef=100")
    print()
...
def example_incremental_insertion():
    ...
    # Build initial index
    index = create_index(algorithm="candy_flat", dimension=dimension, metric="l2")
...
def example_vsag():
    ...
    try:
        ...
        if "Unknown algorithm" in str(e):
            ...
            print(
                "To install: cd implementations/vsag && make pyvsag && pip install wheelhouse/pyvsag*.whl"
            )
        else:
            raise
    print()
...
def example_gti():
    ...
    try:
        ...
        index = create_index(algorithm="gti", dimension=dimension, metric="l2", m=16, L=100)
...
def example_different_metrics():
    ...
    for metric in metrics:
        try:
            index = create_index(algorithm="faiss_hnsw", dimension=dimension, metric=metric, M=16)
