...
from sage_anns.interface.base import AnnIndex, AnnIndexMeta
from sage_anns.interface.factory import register
...
class DummyBruteForce(AnnIndex):
    ...
    def insert(self, vectors: np.ndarray, ids: npt.NDArray[np.uint32]) -> None:
        ...
        for vec, vid in zip(vectors, ids):  # noqa: B905
    ...
    def delete(self, ids: npt.NDArray[np.uint32]) -> None:
        ...
        keep_vecs = []
        keep_ids = []
        for vec, vid in zip(self._vectors, self._ids):  # noqa: B905
